...
use crate::{EthVersion, NetworkTypes, SharedTransactions};
...
pub struct ProtocolMessage<T: NetworkTypes> {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum EthMessage<T: NetworkTypes> {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub enum EthBroadcastMessage<T: NetworkTypes> {
